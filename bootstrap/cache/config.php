<?php return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => 'E:\\Silonet web Gambling\\storage\\framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => 'E:\\Silonet web Gambling\\storage\\app',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => 'E:\\Silonet web Gambling\\storage\\app/public',
        'url' => '/storage',
        'visibility' => 'public',
      ),
      'ftp' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => 'E:\\Silonet web Gambling\\storage\\logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => 'E:\\Silonet web Gambling\\resources\\views/vendor/mail',
      ),
    ),
  ),
  'payments' => 
  ...
  array (
    ...
    'encrypt' => false,
    'files' => 'E:\\Silonet web Gambling\\storage\\framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    'store' => 'json',
    'path' => 'E:\\Silonet web Gambling\\storage/settings.json',
    'connection' => NULL,
    'table' => 'settings',
    'keyColumn' => 'key',
    'valueColumn' => 'value',
  ...
  array (
    'paths' => 
    array (
      0 => 'E:\\Silonet web Gambling\\resources\\views',
    ),
    'compiled' => 'E:\\Silonet web Gambling\\storage\\framework\\views',
  ),
  'trustedproxy' => 
  array (
    'proxies' => NULL,
